...
📌 Примечание:
Из локальной сети также можно подключиться через V2Ray. В этом случае необходимо настроить на маршрутизаторе статический DNS, который будет перенаправлять трафик на Caddy на порт 443
...
1. Скачайте и установите для Android TV [v2rayNG](https://en.v2rayng.org/) или Apple TV [Shadowrocket](https://apps.apple.com/us/app/shadowrocket/id932747118) (доступно в App Store, платное).
